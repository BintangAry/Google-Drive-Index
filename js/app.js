...
<br>
<footer class="footer text-muted"> <div class="container"> <p class="float-right"> <a href="#">Back to top</a> </p> ${UI.credit ? '<a href="https://drive.bintangarya777.workers.dev/"target="_blank"> <img width="300px" height="" scr="https://cdn.jsdelivr.net/gh/BintangAry/Google-Drive-Index@master/images/logobin.png"> </a>' : ''} <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> </div> </footer>
  `;
    $('body').html(html);
}
